...
function rupiah($nilai, $pecahan = 0) {
 ...
 <div class="container-fluid" style="margin:50px 10px 50px 10px;">
       ...
       <form method="get">
         <div class="form-group">
           ...
           <select name="filter" onchange="form.submit()" class="form-control">
              ...
              <option value="Jaminan Kualitas" <?php if($filter == 'Jaminan Kualitas'){ echo 'selected'; } ?>>Jaminan Kualitas</option>
              ...
              <option value="Supply Chain Management" <?php if($filter == 'Supply Chain Management'){ echo 'selected'; } ?>>Supply Chain Management</option>
   ...
   <div class="row" style="margin-top:50px;">
       <h4 class="text-center">Data Karyawan PT. Sepatu Family Group 2018</h4>
   </div>
